...
/*
|--------------------------------------------------------------------------
| Líneas de idioma de validación — Español (Bolivia)
|--------------------------------------------------------------------------
|
| Las siguientes líneas de idioma contienen los mensajes de error
| predeterminados que usa la clase de validación de Laravel.
| Algunos de estos mensajes tienen múltiples versiones (para reglas
| que aplican a tamaño de archivos, cadenas o valores numéricos).
|
*/
...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Mensajes personalizados — Módulo de productos Finora
    |--------------------------------------------------------------------------
    */
    'custom' => [
        'codigo' => [
            'required' => 'El código de producto es obligatorio.',
            'unique'   => 'El código ":input" ya está en uso por otro producto. Utilice un código único.',
            'max'      => 'El código de producto no puede superar los 80 caracteres.',
        ],
        'nombre' => [
            'required' => 'El nombre comercial del producto es obligatorio.',
            'max'      => 'El nombre del producto no puede superar los 180 caracteres.',
        ],
        'precio_venta_actual' => [
            'required' => 'El precio de venta es obligatorio.',
            'numeric'  => 'El precio de venta debe ser un número válido (ej. 35.00).',
            'min'      => 'El precio de venta no puede ser negativo.',
        ],
        'proveedor_id' => [
            'required' => 'Debe seleccionar un proveedor.',
            'exists'   => 'El proveedor seleccionado no existe en el sistema.',
        ],
        'categoria_id' => [
            'required' => 'Debe seleccionar una categoría.',
            'exists'   => 'La categoría seleccionada no existe en el sistema.',
        ],
        'linea_id' => [
            'exists' => 'La línea comercial seleccionada no existe en el sistema.',
        ],
        'imagen' => [
            'image' => 'El archivo seleccionado no es una imagen válida. Formatos admitidos: JPG, PNG, WebP, GIF.',
            'max'   => 'La imagen no puede superar los 2 MB (2048 KB).',
        ],
        'imagen_url' => [
            'url' => 'La URL de imagen externa no tiene un formato válido. Debe comenzar con http:// o https://.',
            'max' => 'La URL de imagen externa no puede superar los 255 caracteres.',
        ],
    ],

    /*
    |--------------------------------------------------------------------------
    | Nombres de atributos personalizados (complementan attributes() en Request)
    |--------------------------------------------------------------------------
    */
    'attributes' => [],
